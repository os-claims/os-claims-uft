...
If strTestcase_Envi is Nothing Then
  ...
  '  objEnv.Item ("Server") = "AdminQALab002;QA DEV LAB"
  '  objEnv.Item ("Site") = "QA DEV LAB"
   ' objEnv.Item ("Application") = "QNXT"
   ' objEnv.Item ("IEVersion") = "CHROME"
   ' objEnv.Item ("Environment") = "HPA_AZURE"
...
'Environment.Value ("Site") = "QA DEV LAB"
'Environment.Value("Application")= "QNXT"
'Environment.Value("IEVersion")= "CHROME"
'Environment.Value("Environment")= "HPA_Azure"
'Environment.Value ("Server")="AdminQALab002"
'Environment.Value("WorkingEnvironment")="QA DEV LAB"


bln_Flag = False
flagsmoke=0
flagReg=0
' To handle both smoke and Regression folders

StrPath = Pathfinder.Locate("..\..\..\..\..\")
If INSTR(StrPath, "HPA_Test\") Then 
...
' GetAUTRootfolder contains folder till HPA_Test

If flagsmoke=1 Then
	StrSettingspath = "..\..\..\..\Test Resources_Claims\Settings\"
End If
...
'StrSettingspath = "..\..\..\..\Test Resources\Settings\"
...
Environment.Value("SETTINGS_LEVEL") = GetAUTRootfolder&"Test Resources_Claims\Settings\"
Environment.Value("VBS_LEVEL") = GetAUTRootfolder&"Test Resources_Claims\Libraries\HPALibrary\"
Environment.Value("OR_LEVEL") = GetAUTRootfolder&"Test Resources_Claims\Object Repositories\"
Environment.Value("INI_LEVEL") = GetAUTRootfolder&"Test Resources_Claims\Initilization\"
Environment.Value("ENVIRONMENT_LEVEL") = GetAUTRootfolder&"Test Resources_Claims\Environment\"
Environment.Value("LOOP") = GetAUTRootfolder&"Test Resources_Claims\Loop\"
Environment.Value("MACRO") = GetAUTRootfolder&"Test Resources_Claims\Macro\837\"
...
Loadfunctionlibrary  Environment.Value("VBS_LEVEL") & "GenericFunctionLibrary_new.qfl"
    ...
    For intTestStepCount= intStartCount To intEndCount step 1
        ...
        '# Generic Actions            
                Case "LAUNCH"    
					...
					intCallReturn=LaunchURLfromEnvSheet_ChromeURL(strServer,strApplication)
					
                Case "LAUNCH_EDGE"    
				    strServer = Environment.Value ("Server")
				    strApplication = Environment.Value("Application")
        
					intCallReturn=LaunchURLfromEnvSheet_Edge(strServer,strApplication)
					
						Case "LAUNCHANDLOGIN"    
				    strServer = Environment.Value ("Server")
				    strApplication = Environment.Value("Application")
        
					intCallReturn=LaunchURLandLoginfromEnvSheet(strServer,strApplication)
