...
Environment.LoadFromFile StrSettingspath&"Env_VUE360.xml"
...
Loadfunctionlibrary  Environment.Value("VBS_LEVEL") & "GenericFunctionLibrary_VUE360.qfl"
...
Case "LAUNCH_EDGE"    
			...
			Case "OPTIONAL"						
               ...
               Case "GETPOSITION"			
                ...
                Case "VALIDATEPDF"
                    intCallReturn = Fn_Gen_ValidateReportPDF(G)
                    
                    
                Case "VALIDATEPROVPDF"
                    intCallReturn = Fn_Gen_ValidateProvReportPDF(G)
                ...
                Case "VALIDATEAUTHPDF"
                    intCallReturn = Fn_Gen_ValidateAuthReportPDF(G)

                    
                    
                Case "VALIDATEMEMPDF"
                    intCallReturn = Fn_Gen_ValidateMemReportPDF(G)
